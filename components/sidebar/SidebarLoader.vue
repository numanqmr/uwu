  ...
  >
    ...
    >
      <div class="w-100 column flex flex-col items-center justify-center pb-8">
        <div class="h-14 w-14 animate-pulse rounded-full bg-slate-300" />
        <div class="mt-2 h-4 w-36 animate-pulse rounded bg-slate-300" />
        <div class="mt-2 h-4 w-28 animate-pulse rounded bg-slate-300" />
      </div>

      <ul class="space-y-2 font-medium">
        <li v-for="index in [...Array(4)]" :key="`sidebar-loader-${index}`">
          <div
            class="flex h-[40px] animate-pulse items-center rounded-lg bg-slate-300 p-2 dark:bg-gray-700"
          ></div>
        </li>
      </ul>
      ...
      >
        <li>
          ...
          >
            <div
              class="flex h-[40px] w-full items-center rounded-lg bg-slate-300 p-2 dark:bg-gray-700"
            />
          </div>
        </li>
      </ul>
