  ...
  <div>
    <NuxtLayout :name="`auth-layout`">
      <div class="pt-8">
        ...
        <div class="mb-8">
          <div class="text-2xl font-bold dark:text-white mb-4">
            Your insights
          </div>
          <div class="mt-8 bg-slate-400 rounded-lg p-4">
      ...
      <!--  -->
      <div class="pt-8 px-4">
        <div class="text-2xl font-bold dark:text-white mb-4">Your Profile</div>
        <div
